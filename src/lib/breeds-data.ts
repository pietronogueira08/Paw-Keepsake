...
export const BREEDS: Breed[] = [
  ...
  },
  {
    ...
    svgPath:
      'M 100 32 C 84 26 70 36 64 52 C 52 42 38 52 40 66 ' +
      'C 30 72 26 88 34 100 C 28 112 30 128 42 136 ' +
      'C 46 150 58 160 74 162 C 84 170 92 172 100 170 ' +
      'C 108 172 116 170 126 162 C 142 160 154 150 158 136 ' +
      'C 170 128 172 112 166 100 C 174 88 170 72 160 66 ' +
      'C 162 52 148 42 136 52 C 130 36 116 26 100 32 Z ' +
      'M 66 50 C 56 36 38 44 40 60 C 42 72 60 76 70 64 Z ' +
      'M 134 50 C 130 64 140 72 160 60 C 162 44 144 36 134 50 Z',
  },
];
